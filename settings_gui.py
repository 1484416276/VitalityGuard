...
class SettingsGUI:
    ...
    def create_widgets(self):
        ...
        self.option_lang = ctk.CTkOptionMenu(
            self.lang_frame,
            values=["zh_CN", "en_US", "ja_JP", "ko_KR", "fr_FR", "de_DE", "es_ES", "ru_RU"],
    ...
    def load_mode_settings(self):
        ...
        self.chk_black_screen_unlock = ctk.CTkCheckBox(
            self.settings_frame,
            text=i18n.get("allow_black_screen_unlock"),
            variable=self.var_black_screen_unlock
        )
    ...
    def save_settings(self, show_message=True):
        current_config = self.config["modes"]["default"]
        ...
        try:
            ...
            current_config["allow_black_screen_unlock"] = self.var_black_screen_unlock.get()
