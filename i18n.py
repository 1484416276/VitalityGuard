...
TRANSLATIONS = {
    "zh_CN": {
        ...
        "allow_black_screen_unlock": "允许黑屏时解锁（按钮点击和ESC按键5次）",
        "auto_start": "开机自启动",
    ...
    "en_US": {
        ...
        "allow_black_screen_unlock": "Allow unlock during black screen (button and ESC x5)",
    ...
    "ko_KR": {
        ...
        "current_mode": "현재 모드:",
        "save_restart": "설정 저장 후 재시작",
        "work_duration": "작업 시간 (분):",
        "rest_duration": "블랙 스크린 시간 (분):",
        "countdown": "카운트다운 (초, 0=끄기):",
        "allow_black_screen_unlock": "블랙 스크린 중 해제 허용(버튼 및 ESC 5회)",
    ...
    "fr_FR": {
        ...
        "rest_duration": "Durée écran noir (min) :",
        "countdown": "Compte à rebours (s, 0=off) :",
        "allow_black_screen_unlock": "Autoriser le déverrouillage pendant l'écran noir (bouton et ESC x5)",
    ...
    "de_DE": {
        ...
        "allow_black_screen_unlock": "Entsperren während Schwarzbild erlauben (Button und ESC x5)",
    ...
    "es_ES": {
        ...
        "work_duration": "Trabajo (min):",
        "rest_duration": "Pantalla negra (min):",
    ...
    "ru_RU": {
        ...
        "allow_black_screen_unlock": "Разрешить разблокировку во время чёрного экрана (кнопка и ESC x5)",
